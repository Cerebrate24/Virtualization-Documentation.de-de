...
# [Erstellen eines virtuellen Computers](quick-start/quick-create-virtual-machine.md)

# Verwalten virtueller Computer mit Hyper-V
## [Hyper-V und PowerShell](quick-start/try-hyper-v-powershell.md)
## [Freigeben von Geräten mit VMs](user-guide/enhanced-session-mode.md)
...
## [Aktivieren geschachtelter Virtualisierung](user-guide/nested-virtualization.md)
## [Erstellen eines benutzerdefinierten VM-Katalogs](user-guide/custom-gallery.md)
...
## [Hyper-V-Sicherungsansätze](reference/HyperVBackupApproaches.md)
